...
import com.yssh.scan.Activit_input;
import com.yssh.scan.R;
import com.yssh.scan.WebActivity;
import com.yssh.scan.tools.BitmapUtil;
...
public class CaptureActivity extends AppCompatActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnAlbum = findViewById(R.id.tv_album);
        ...
        tv_input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CaptureActivity.this, Activit_input.class);
